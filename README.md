...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=23178743&assignment_repo_type=AssignmentRepo)


## 🛠️ System Architecture & Setup Instructions

### Local Environment Setup
To run and test this platform locally on your machine:
1. Clone or download this project repository.
2. Ensure your directory structure is organized exactly as follows:
   ```text
   ├── index.html          # Homepage with structural introduction
   ├── about.html          # Company services layout
   ├── media.html          # Advanced audio, video, and gallery integration
   ├── contact.html        # Accessible form validation implementation
   ├── css/
   │   └── styles.css      # Core stylesheet using Grid Areas & Fluid Layouts
   ├── images/             # Optimised structural image assets
   └── media/              # Video tracks, audio configurations, and sub-titles
